<%@ Page Title="" Language="C#" MasterPageFile="~/ContactBookInternalMasterPage.master" AutoEventWireup="true" CodeFile="module_TaoDeLuyenTap_Version2.aspx.cs" Inherits="admin_page_module_function_module_TracNghiem_module_TaoDeLuyenTap_Version2" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="BottomWrapper" runat="Server">
    ...
    <div class="card section-content">
        <div class="container mt-1">
            <p class="heading-nhapsach">Tạo bài luyện tập ngẫu nhiên</p>
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div>
                        <div class="form-row">
                            <label class="col-2 col-form-label">Tên bài luyện tập <span class="text-danger">(*)</span> :</label>
                            <div class="col-8">
                                <input type="text" class="form-control" id="txtTenBai" runat="server" />
                            </div>
                        </div>
                        <div class="form-row my-1">
                            <label class="col-2 col-form-label">Số lượng câu hỏi <span class="text-danger">(*)</span>:</label>
                            <div class="form-row">
                                <div class="ml-2">
