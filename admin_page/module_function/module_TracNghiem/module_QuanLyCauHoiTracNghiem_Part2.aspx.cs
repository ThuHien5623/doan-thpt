...
public partial class admin_page_module_function_module_TracNghiem_module_QuanLyCauHoiTracNghiem : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        var getCH_TN = from ch in db.tbTracNghiem_Question_Part23s
                       ...
                       && ch.hidden == false && ch.question_part == 2
    ...
    protected void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        //}
        else if (edtDapAnA.Html == "" || edtDapAnB.Html == "" || edtDapAnC.Html == "" || edtDapAnD.Html == "")
        {
    ...
    protected void btnChiTiet_Click(object sender, EventArgs e)
    {
        ...
        {
            rdDung1.Checked = true;
            rdSai1.Checked = false;
            countDADung++;
        }
        else
        {
            rdDung1.Checked = false;
            rdSai1.Checked = true;
        }
    ...
    private void themdata()
    {
        ...
        tbTracNghiem_Answer_Part23 dapanB = new tbTracNghiem_Answer_Part23();
        ...
        db.tbTracNghiem_Answer_Part23s.InsertOnSubmit(dapanB);
        tbTracNghiem_Answer_Part23 dapanC = new tbTracNghiem_Answer_Part23();
        ...
        db.tbTracNghiem_Answer_Part23s.InsertOnSubmit(dapanC);
        tbTracNghiem_Answer_Part23 dapanD = new tbTracNghiem_Answer_Part23();
        ...
        db.tbTracNghiem_Answer_Part23s.InsertOnSubmit(dapanD);
        db.SubmitChanges();
