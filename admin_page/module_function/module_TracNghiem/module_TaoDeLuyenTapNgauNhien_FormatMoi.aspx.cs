...
public partial class admin_page_module_function_module_TracNghiem_module_TaoDeLuyenTapNgauNhien_FormatMoi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ddlKhoi.SelectedValue != "")
            {
                ...
                //var listMon = from  m in db.tbTKB_Mons 
                //              select m;
    ...
    protected void LuuKetQuaTracNghiem()
    {
        ...
        db.SubmitChanges();
        test.test_link = "bai-luyen-tap-format-moi-chi-tiet-" + Convert.ToInt32(ddlKhoi.SelectedValue) + "/" + cls_ToAscii.ToAscii(txtTenBai.Value.ToLower()) + "-" + test.test_id;
        db.SubmitChanges();
