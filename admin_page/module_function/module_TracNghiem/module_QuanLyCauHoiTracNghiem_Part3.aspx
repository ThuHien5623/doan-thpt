<%@ Page Language="C#" AutoEventWireup="true" CodeFile="module_QuanLyCauHoiTracNghiem_Part3.aspx.cs" Inherits="admin_page_module_function_module_TracNghiem_module_QuanLyCauHoiTracNghiem" %>
            ...
            <div class="card">
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-sm-4 question_radio" id="DangCauHoi_" style="display: none">
                    ...
                    <ContentTemplate>
                        <div class="row">
                            <div class="col-6">
                                <div class="">
                                    <div id="dvnoidungcauhoi">
                                        ...
                                        <dx:ASPxHtmlEditor ID="edtContent" ClientInstanceName="edtContent" runat="server" Width="100%" Height="300px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd" OnHtmlCorrecting="edtContent_HtmlCorrecting">
                            ...
                            <div class="col-6">
                                ...
                                <textarea id="txtDapAn" class="form-control boxed" style="height: 300px" runat="server"></textarea>
                            </div>
                        </div>
                        <div class="up-1">
                            <div class="content-headertl">
