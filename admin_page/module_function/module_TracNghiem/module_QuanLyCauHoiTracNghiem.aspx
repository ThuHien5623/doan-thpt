        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="content-headertl-out">
                    ...
                    <a href="/admin-quan-ly-module-trac-nghiem-version2" class="btn btn-primary  btn-sm mr-1">Quay lại</a>
                </div>
                <div class="row up-1 but-1">
                    <div class="col-3">
                        ...
                        <div class="popup-main__insert">
                            <b>Lưu ý: 
                                <br />
                                - Bạn cần nhập nội dung đáp án theo thứ tự A,B,C,D
                                 <br />
                                - Chỉ chọn 1 đáp án đúng </b>
                            <br />
                            <label>Dạng câu hỏi:</label>
                            <asp:DropDownList runat="server" ID="ddlLoaiCauHoi" onChange="showIconLoading()" CssClass="drlist" OnSelectedIndexChanged="ddlLoaiCauHoi_SelectedIndexChanged" AutoPostBack="true">
                            ...
                            <label>Đặc tả:</label>
                            <asp:DropDownList runat="server" CssClass="drlist" ID="ddlDacTa">
                            </asp:DropDownList>
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <div id="DangCauHoi_">
                                        <label>Kiểu câu hỏi:</label>
                                        <input class="radio_text_type" type="radio" checked="checked" id="type1" name="kieucauhoi" value="1" onclick="setForm()" />Text + Image 
                                        <input class="radio_text_type" type="radio" id="type2" name="kieucauhoi" value="2" onclick="setForm()" />Video 
                                    </div>
                                    <label>Mức độ:</label>
                                    <input class="radio_text_type" type="radio" checked="checked" id="21" name="loaicauhoi" value="Dễ" onclick="getquestion()" />Dễ
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                ...
                                <dx:ASPxHtmlEditor ID="edtGiaiThich" ClientInstanceName="edtGiaiThich" runat="server" Width="100%" Height="300px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd" OnHtmlCorrecting="edtGiaiThich_HtmlCorrecting">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div id="dvnoidungcauhoi">
                                            ...
                                            <dx:ASPxHtmlEditor ID="edtContent" ClientInstanceName="edtContent" runat="server" Width="100%" Height="900px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd" OnHtmlCorrecting="edtContent_HtmlCorrecting">
                                                <SettingsHtmlEditing EnablePasteOptions="true" />
                                                <Settings AllowHtmlView="true" AllowContextMenu="Default" />
                                                <settingsimageupload uploadfolder="~/editorimages"></settingsimageupload>
                                                <Toolbars>
                ...
                <b>Note: Nội dung đặc tả các thầy/cô có thể nhập bổ sung sau!
                </b>
                <div class="col-12">
                    <div class="row up-1 but-1">
                        ...
                        <asp:UpdatePanel runat="server" ID="uppanelXoa">
                            <ContentTemplate>
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary mr-1" onclick="confirmDel()">Xóa</a>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        ...
                        <%--<a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Nhập file excel </a>--%>
                        <a href="/admin-dac-ta" class="btn btn-primary btn-sm mr-1">Thêm đặc tả</a>
                    </div>
                    <div class="row">
