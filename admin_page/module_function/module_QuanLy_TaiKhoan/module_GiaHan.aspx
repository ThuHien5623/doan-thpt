<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_GiaHan.aspx.cs" Inherits="admin_page_module_function_module_WebSite_module_DangKy" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="card card-block">
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="lichsugianhan_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Họ tên học sinh" FieldName="children_fullname" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Lớp" FieldName="lop_name" HeaderStyle-HorizontalAlign="Center" Width="10%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Gói" FieldName="lichsugianhan_goigiahan" HeaderStyle-HorizontalAlign="Center" Width="10%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Trình trạng" FieldName="lichsugianhan_tinhtrang" HeaderStyle-HorizontalAlign="Center" Width="10%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                </Columns>
