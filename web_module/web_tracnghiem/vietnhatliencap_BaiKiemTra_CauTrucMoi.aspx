<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vietnhatliencap_BaiKiemTra_CauTrucMoi.aspx.cs" Inherits="web_module_web_tracnghiem_vietnhatliencap_BaiKiemTra_CauTrucMoi" %>
            ...
            <div id="content-main">
                <div class="container">
                    ...
                    <div class="testing m-bottom get_width" id="content-test-detail">
                        <p><b>PHẦN I: Trắc nghiệm 4 lựa chọn </b></p>
                                    ...
                                    <div class="question-box">
                                        <div class="panel panel-default question-item" id="<%#Eval("question_id") %>" data-question-number="<%#Eval("question_id") %>">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-row answer">
                                                    <div class="flex">
                                                        <asp:Repeater runat="server" ID="rpCauTraLoi">
                                                            <ItemTemplate>
                                                                <div class="answer-item col-12 mx-2">
                                                ...
                                                <button type="button" class="btn btn-primary btnShowGiaiThich <%#Eval("style") %>" data-toggle="modal" data-target="#modalGiaiThich<%#Eval("question_id") %>" style="display: none">
                                                    Giải thích
                                                </button>
                        ...
                        <p><b>PHẦN II: Câu trắc nghiệm đúng sai </b></p>
                        <div>
                                                                ...
                                                                <tr class="cau-hoi-nho">
                                                                    ...
                                                                    <td>
                                                                        <div class="content_image">
                                                                            <label class="radio_question mr-2">
                                                                                <input class="hidden-print" type="radio" data-question="<%#Eval("question_id") %>" value="<%#Eval("result") %>" data-id="<%#Eval("answer_id") %>" data-answer="True" name="checkDungSai_<%#Eval("answer_id") %>" />
                                                                                <span class="pl-1">Đúng</span>
                                                                            </label>
                                                                            <label class="radio_question">
                                                                                <input class="hidden-print" type="radio" data-question="<%#Eval("question_id") %>" value="<%#Eval("result") %>" data-id="<%#Eval("answer_id") %>" data-answer="False" name="checkDungSai_<%#Eval("answer_id") %>" />
                                                                                <span class="pl-1">Sai</span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <div class="question-box">
                                        <div class="panel panel-default question-item" id="<%#Eval("question_id") %>" data-question-number="<%#Eval("question_id") %>">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-row answer">
                                                    <span><b>Đáp án:</b></span>
                                                    <input type="text" name="questionPart3" data-value="<%#Eval("result") %>" autocomplete="off" class="form-control" />
                                                </div>
                                                <button type="button" class="btn btn-primary btnShowGiaiThich <%#Eval("style") %>" data-toggle="modal" data-target="#modalGiaiThich<%#Eval("question_id") %>" style="display: none">
                                                    Giải thích
                                                </button>
                    ...
                    <div>
                        ...
                        <a href="javascript:void(0)" id="btnReStart" onclick="funcReStart()" class="btn btn-success mx-1">Làm lại</a>
