<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageGameTHPT.master" AutoEventWireup="true" CodeFile="thpt_LuyenTap.aspx.cs" Inherits="web_module_module_THPT_thpt_LuyenTap" %>
    ...
    <div class="page-view bg-color-1 m-bottom">
        ...
        <div class="block-content no-pd">
            <div class="block-content__header">
                <img class="--title" src="/images/luyentap.png" alt="Alternate Text" />
