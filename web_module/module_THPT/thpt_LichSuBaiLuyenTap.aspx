<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageGameTHPT.master" AutoEventWireup="true" CodeFile="thpt_LichSuBaiLuyenTap.aspx.cs" Inherits="web_module_module_THPT_thpt_LichSuBaiLuyenTap" %>
    ...
    <div class="page-view bg-color-1 m-bottom">
        ...
        <div class="block-content min-h-1">
            <div class="block-content__header">
                <img class="--title" src="/images/bg-lichsubailuyentap-thcs.png" alt="Alternate Text" />
                                        ...
                                        <asp:Repeater ID="rpThanhTich" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%#Convert.ToDateTime(Eval("resulttest_datetime")).ToShortDateString()%></td>
